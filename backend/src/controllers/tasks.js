...
export const addBudget = async(req, res) => {
    if(!await existBudget(req.body.budgetReference, req.body.budgetNumber)){
        const connection = await connect();
        await connection.query("INSERT INTO budgets (id, creation_date, budget_number, total_costs, photographic_production, agency_fee, total_budget, expiration_date, iban, user) values (?,?,?,?,?,?,?,?,?,?)",
        [req.body.budgetReference, req.body.creationDate, req.body.budgetNumber, req.body.budgetTotalCosts, req.body.photographicProduction, req.body.agencyFee, req.body.totalBudget, req.body.budgetExpirationDate, req.body.budgetIBAN, req.body.user]);
...
export const modifyBudget = async(req, res) => {
    if(await existBudget(req.body.budgetReference, req.body.budgetNumber)){
        const connection = await connect();
        await connection.query("UPDATE budgets SET creation_date = ?, total_costs = ?, photographic_production = ?, agency_fee = ?, total_budget = ?, expiration_date = ?, iban = ? WHERE id = ? AND budget_number = ?",
        [req.body.creationDate, req.body.budgetTotalCosts, req.body.photographicProduction, req.body.agencyFee, req.body.totalBudget, req.body.budgetExpirationDate, req.body.budgetIBAN, req.body.budgetReference, req.body.budgetNumber]);
